...
<a href="assets/images/75.png"><img src="assets/thumbs/75.jpg" alt="ALIENTEK T90B" width="220" height="140"></a>

Так как я паял не так что бы много и паять пришлось бы достаточно много мелких деталей, я бы одурел делать это советским паяльником. Поэтому был при обретен новый современный. Паяльник, кстати, оказался очень крутым, покупался по наводке Гайвера (Заметки Ардуинщика, иногда посматривал его видосы, а тут еще и пригодилось): быстрый разогрев за 5-10 секунд, питание от обычного повербанка, настройка температуры и удобная ручка. Важный момент: нужен мягкий USB-C кабель под высокий вольтаж. В комплекте он был.
...
Потом первые тесты: устройство уже видно в компьютере без прямого подключения. На заднем плане еще старая схема с отдельной кнопкой включения. Но уже видно что устройство определилось как блютус клавиатура.

<a href="assets/images/12.jpg"><img src="assets/thumbs/12.jpg" alt="Первый беспроводной тест" width="220" height="140"></a>

Дальше - пайка всего устройства. Почти сразу стало понятно, что без “третьей руки” будет тяжело: контакты мелкие, плату нужно держать, а видеть хочется больше. Ее я заказывал с перерывом в неделю, я в этот момент был в Москве на Гамеднях и с подругой Олей (<https://www.twitch.tv/trolechka_>) стояли в ночной шавухе. Я ей рассказывал чуть деталей, мол вот собираю уже почти все готово, но паять трудно, была бы третья рука, было бы проще. А сам думаю какого черта.. И там же заказал, пока готовилась шавуха. Хеля, кстати, отказалась от шавухи и не пошла с нами, она на диете.

Лупа с третьей рукой нереально сильно упростила жизнь и ускорила пайку.
...
Пришлось повозиться со страницей, в целом нейронка все быстро сверстала, даже какой то общий стиль. Но она упорно путала идентификаторы устройства. Поэтому нужна была постоянная правка, то в скетче, то на самой странице. Но я справился.

Саму же страницу я разместил у себя на сайте. Вспомнив такой фильм как Сеть (1995), я добавил маленький символ Пи, по нажатию на который открывается конфигуратор. В фильме Сандра Буллок, через него получала доступ к базе данных через бекдок. Тут конечно не взлом как в фильме, но все же :D

## Корпус

Отдельная глава боли - корпус и покраска.

Сначала я сделал корпус высотой 40 мм, но после печати стало понятно, что он смотрится плохо: слишком высокий, плюс при печати лежа появились “лесенки”. Тогда я решил печатать стоя (не я сам стоял, а модель, я в этот момент занимался своими делами) и уменьшил высоту до 25 мм.
...
У модели версия 3.1, потому что было сделано 3 разные версии, под 40мм, под 25мм, и потом я понял что защелки которые я хотел сделать это ерунда, достаточно просто сделать "балкончик". То нужна полка для контроллера заряда, то больше места под крышку, то защелки получаются слишком хлипкими. Всего модель печаталась 11 раз, до конца печати дожили 4 версии. В одном из заходов даже сломался принтер: датчик температуры сопла показывал постоянные 220 градусов...

Сначала я решил перепрошить принтер, вдруг это программная какая то ошибка. Результата никакого не было. Пришлось разобрать сопло принтера, проверить ничего ли не сломалось, проверить нужно ли менять датчик. Было предположение что из-за постоянных срывов печати сопло ударило по модели, от чего она слетела и повредился датчик. Но он пришел в себя и заработал после разбоки. Поэтому принтер благополучно был собран обратно и отправлен печатать новую деталь.
...
Вспоминая где то на задворках памяти, что да... где то я такое видел, я взался за губку. И как результат появилась шагрень - мелкие неровности поверхности. Для устройства, которое хочется держать в руке, это неприятно. Я надеялся, что лак выровнит покрытие. Но... Не выровнял. Там, где поверхность была гладкой, все стало красиво, а там, где была шагрень, стало еще хуже.
...
И тут новая проблема: модель все еще слегка липкая. Быстрый поиск подсказал, что видимо слой лака был слишком толстым и нужна сушка в каком то теплом, сухом месте где то 2-3 суток. Не долго думая я понес в гардероб, где она и пролежала 2 дня. И как результат сушки в гардеробе белая часть облепилась ворсинками. Гардероб оказался худшим местом для сушки свежего лака. Как оказалось, если я правильно понял, от одежды, даже если там не ходить очень много мелких частиц. Лучше бы конечно поместил в какую то закрытую коробку и поставил в ванной у палатенце сушителя.

<a href="assets/images/46.jpg"><img src="assets/thumbs/46.jpg" alt="Ворсинки на покрытии" width="220" height="140"></a>

На этом моменте я сдался и позвал тяжелую артиллерию - Леру: <https://twitch.tv/solodvalery>. Для нее была напечатана еще одна модель в быстром темпе, а вместе с ней отправились лаки, краски, грунтовки, шкурки и все остальное для нормальной покраски.

Было решено капитально переделать способ печати: выставить максимальные режимы сглаживания, спаивания и поддержек, это увеличило время печати почти в 2 раза, с 3.5 часов до 7. А первая модель раслоилась при конце печати... Так что печаталась аж 2 раза (это уже была наверное 10 печать корпуса). Я просто устал от бесконечного брака. Поэтому напечатал модель под углом, чтобы она была максимально крепкой.
...
Лере были отправлены все мои поделки, в том числе пара из многочисленных неудачных печатей. Она сказала надо бы глянуть, как не делать :D

<a href="assets/images/49.jpg"><img src="assets/thumbs/49.jpg" alt="Поделки для Леры" width="220" height="140"></a>

Она зашкурила и покрыла корпус грунтом, а потом наметила логотип. Правда, логотип оказался неправильным, а пока мы переписывались, из-за моего сбитого режима он уже был покрашен неверно. Поэтому Лера решила поправить его прямо на уже покрашенной модели. Но в любом случае получилось аккуратно.
...
Меня больше удивило, что создание и раскраска корпуса заняла чуть ли не в 2 раза больше времени чем разработка и пайка устройства. Это был долгий процесс с кучей проблем. Без опыта тут никуда.
