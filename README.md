...
4. В обычном режиме использовать устройство как Bluetooth-клавиатуру и определяется как RutonyPad.
5. Для настройки, удалить устройство если оно спарено, зажать крайние кнопки по диагонали примерно на 10 секунд. Устройство должно уже определиться как RutonyCfg. Значит оно перешло в режим конфигурации. Не добавлять его как обычное блютус устройство.
6. Открыть [web/index.html](web/index.html) в браузере с поддержкой Web Bluetooth. И подключить RutonyCfg.
7. Настроить клавиши и вернуться в режим клавиатуры.
8. Если не была нажата кнопка режима клавиатуры, зажать диагональные кнопки для смены режима - в режим клавиатуры.
